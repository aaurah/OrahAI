...
export default function RegisterScreen() {
  ...
  const handleRegister = async () => {
    ...
    setError("");
    try {
      await register(email.trim().toLowerCase(), password, username.trim(), name.trim() || undefined);
    } catch (e: unknown) {
  ...
  return (
    ...
    >
      <ScrollView
        contentContainerStyle={[s.container, { paddingTop: insets.top + 40, paddingBottom: insets.bottom + 32 }]}
      ...
      >
        ...
        <Text style={s.subtitle}>Start building with AI assistance</Text>
        ...
        <View style={s.field}>
          ...
          <TextInput
            style={s.input} placeholder="jane_doe"
            placeholderTextColor={colors.mutedForeground}
        ...
        <Pressable
          style={[s.btn, (isLoading || !email || !password || !username) && { opacity: 0.6 }]}
